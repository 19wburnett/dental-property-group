...
import DentalBackground from '../public/images/Dental Office Background Photo.jpeg';
import Nic from '../public/images/Nic.png';
import Spencer from '../public/images/Spencer.png';
import Jaime from '../public/images/Jaime Dunn.jpeg';
import Rob from '../public/images/Rob Bay.jpeg';
import Fabio from '../public/images/Fabio Oliveira.jpeg';
...
Our team is made up of institutionally trained leaders and Board of Advisors comprised of seasoned professionals in the real estate and dental industries. Our aim is to become the go to acquisition partner in the dental industry.</p>
          <Link href='/partner-with-us' className='landing-page-button'>
      ...
      <div className="who-we-are-secondary">
        ...
        <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center'}}> 
          ...
          <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'row', alignItems: 'center', gap: '40px'}}>
            <Link href='/sell-your-office' className='landing-page-button secondary'>
              <div>I have an Individual Deal</div>
            </Link>
            <Link href='/partner-with-us' className='landing-page-button secondary'>
              <div>I have a Large Portfolio</div>
            </Link>
          </div>
